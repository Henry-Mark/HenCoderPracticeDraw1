...
public class Practice11PieChartView extends View {
...

    {
        ...
        models.add(new Model("Ice Cream Sandwich", 15, Color.CYAN));
        models.add(new Model("Jelly Bean", 35, Color.MAGENTA));
        models.add(new Model("Kitkat", 40, Color.LTGRAY));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < models.size(); i++) {
            ...
            canvas.drawArc(rectLeft, rectTop, rectRight, rectBottom, startAngle, angle, true, paint); // 绘制扇形
